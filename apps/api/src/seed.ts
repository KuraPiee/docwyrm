...
`,
  ...
  if (!spaces.has(book2Id)) {
    spaces.set(book2Id, {
      ...
      description: 'Complete endpoint specifications, authentication schemas, and client examples for Docwyrm REST APIs.',
      isPrivate: false,
      isSystemProtected: true,
      themeId: 'default',
      gitProvider: 'GENERIC',
...
`,
  ...
  if (!spaces.has(book3Id)) {
    spaces.set(book3Id, {
      ...
      description: 'Official plugin developer kit, AST transforms, dynamic blocks, and theme marketplace guidelines.',
      isPrivate: false,
      isSystemProtected: true,
      themeId: 'default',
      gitProvider: 'GENERIC',
